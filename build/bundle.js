...
/***/ function(module, exports, __webpack_require__) {
	...
	var _game = __webpack_require__(/*! ./game.jsx */ 168);
	...
	var ChooseCharacter = function (_React$Component) {
	  _inherits(ChooseCharacter, _React$Component);
	
	  function ChooseCharacter() {
	    _classCallCheck(this, ChooseCharacter);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ChooseCharacter).apply(this, arguments));
	  }
	      ...
	      var characters = this.props.characters.map(function (_ref, i) {
	        ...
	        return _react2.default.createElement(
	          ...
	          { className: 'character', onClick: function onClick() {
	              return _this2.props.selectCharacter(i);
	            }, key: i },
	          _react2.default.createElement(
	            'div',
	            { className: '' + selected },
	            _react2.default.createElement('img', { className: 'character-pic', src: './static/img/' + image }),
	            _react2.default.createElement('img', { className: 'party-hat', src: './static/img/partyhat.png' }),
	            _react2.default.createElement(
	              'h1',
	              null,
	              title
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h1',
	            null,
	            'HAPPY 16TH BIRTHDAY ALVIN!'
	          ),
	          characters,
	          _react2.default.createElement(
	            'div',
	            { className: 'button', onClick: function onClick() {
	                return _this3.props.setView(1);
	              } },
	            _react2.default.createElement(
	              'div',
	...
	var Main = function (_React$Component3) {
	  ...
	  function Main(props) {
	    ...
	    _this6.views = [ChooseCharacter, _game2.default, GameOver].map(function (component) {
	  ...
	  _createClass(Main, [{
	    key: 'selectCharacter',
	    value: function selectCharacter(i) {
	    ...
	    value: function render() {
	      ...
	      var views = this.views.map(function (view) {
	        return view({
	          setView: _this7.setView.bind(_this7),
	          setHomeView: _this7.setHomeView.bind(_this7),
	          selectCharacter: _this7.selectCharacter.bind(_this7),
	          selectedCharacter: _this7.state.selectedCharacter,
	          setFinalScore: _this7.setScore.bind(_this7),
	          characters: _this7.characters,
	          finalScore: _this7.finalScore
	        });
	      });
	      return _react2.default.createElement(
	        'div',
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'stats-container-container' },
	              _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'h2',
	                    { className: 'danish-show' },
	                    'PUNTER: ' + this.state.score
	                  )
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'stats lives lives-' + this.state.lives },
	                  _react2.default.createElement(
	                    'h2',
	                    { className: 'normal-show' },
	                    'Lives:',
	                    _react2.default.createElement('img', { className: 'life life-1', src: './static/img/little' + this.characterImage }),
	                    _react2.default.createElement('img', { className: 'life life-2', src: './static/img/little' + this.characterImage }),
	                    _react2.default.createElement('img', { className: 'life life-3', src: './static/img/little' + this.characterImage })
	                  ),
	                  _react2.default.createElement(
	                    'h2',
	                    { className: 'danish-show' },
	                    'LIV:',
	                    _react2.default.createElement('img', { className: 'life life-1', src: './static/img/fish.png' }),
	                    _react2.default.createElement('img', { className: 'life life-2', src: './static/img/fish.png' }),
	                    _react2.default.createElement('img', { className: 'life life-3', src: './static/img/fish.png' })
	                  )
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'stats normal-show' },
	                  _react2.default.createElement(
	                    'h2',
	                    null,
	                    'Points until Danish Mode: ' + (this.state.danishPoints - this.state.score)
	                  )
	                )
	              )
	            )
	          ),
	          _react2.default.createElement('img', { className: 'player', style: { left: this.state.playerX + 'px', top: this.state.playerY + 'px' }, src: './static/img/' + this.characterImage }),
	          objects
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'lower-bar', style: { height: window.innerHeight - this.state.playerY - 80 + 'px' } },
	          _react2.default.createElement(
	            'h1',
	            { className: 'normal-show' },
	            'Catch the birthday stuff using the arrow keys!'
	          ),
	          _react2.default.createElement(
	            'h1',
	            { className: 'danish-show' },
	            'DANSK MODE AKTIVERET'
	          )
	        )
	      );
	    }
